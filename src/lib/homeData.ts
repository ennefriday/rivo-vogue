...
export const AUDIENCE_LIST: AudienceItem[] = [
  {
    ...
    description: 'Immaculate wedding gowns, cathedral veils, and personalized fitting journeys crafted to make you unforgettable.',
    badge: 'Bridal Collection',
    imageSrc: '/media/audience/bride.jpg',
  },
  {
    id: 'bridal-trains',
    title: 'Bridesmaids & Bridal Trains',
    subtitle: 'Coordinated Harmony',
    description: 'Harmonious silhouette ensembles and complementary palettes tailored to elevate the bridal entourage seamlessly.',
    badge: 'Entourage Styling',
    imageSrc: '/media/audience/bridal-train.jpg',
  },
  {
    id: 'asoebi-groups',
    title: 'Wedding Guests & Asoebi Groups',
    subtitle: 'Cultural Splendor',
    description: 'Bespoke lace, george, and luxury fabric transformations engineered to turn heads at celebratory gatherings.',
    badge: 'Asoebi Specialization',
    imageSrc: '/media/audience/asoebi.jpg',
  },
  {
    id: 'gala-attendees',
    title: 'Red Carpet & Gala Attendees',
    subtitle: 'High-Society Glamour',
    description: 'Showstopping evening wear, dramatic corsetry, and sculpted gowns commanding distinction on grand stages.',
    badge: 'Haute Couture',
    imageSrc: '/media/audience/gala.jpg',
  },
  {
    id: 'fashion-forward',
    title: 'Fashion-Forward Women',
    subtitle: 'Curated Elegance',
    description: 'Statement designer footwear, hand-beaded clutches, and intoxicating niche perfumes to complete your signature look.',
    badge: 'Accessories & Scent',
    imageSrc: '/media/audience/accessories.jpg',
  },
  {
    id: 'luxury-shoppers',
    title: 'Curated Luxury Shoppers',
    subtitle: 'Exclusive Boutique',
    description: 'Handpicked international couture pieces, limited-edition accessories, and ready-to-wear statement staples.',
    badge: 'Boutique Collection',
    imageSrc: '/media/audience/boutique.jpg',
  },
  {
    id: 'aspiring-designers',
    title: 'Aspiring Fashion Designers',
    subtitle: 'Atelier Academy',
    description: 'Intensive masterclasses in pattern drafting, luxury sewing techniques, and sustainable fashion business leadership.',
    badge: 'Fashion Academy',
    imageSrc: '/media/audience/academy.jpg',
  },
];
