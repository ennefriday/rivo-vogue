      ...
      <section ref={ref} className="flex py-20 md:py-24 px-6 lg:px-12 text-brand-charcoal text-center flex-col items-center justify-center relative overflow-hidden bg-brand-pink/20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/30 border border-brand-charcoal/20 md:backdrop-blur-xl mb-8"
          >
          ...
          >
            ...
            <a
              ...
              className="group w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 border border-brand-charcoal/30 text-brand-charcoal hover:border-brand-charcoal transition-colors duration-500 font-sans tracking-wider text-sm uppercase relative overflow-hidden bg-white/10 md:backdrop-blur-sm"
            >
